...
@z.task
def task_on_the_main_file(somestring: str, some_int: int, some_float: float, some_list: list = ["aa", "bb", "cc"], favorite_number=42, workdir: str = None, root_url="http://blah", *vararg):
